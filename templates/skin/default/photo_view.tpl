<div>
    ...
    {if $bSliderImage}
        <div class="gallery-navigation">
            {if $oPrevImage}
                <a class="gal-right ajaxy" data-image-id="{$oPrevImage->getId()}" href="{$oPrevImage->getUrlFull()}?order={$sOrder}">
            ...
            {if $oNextImage}
                <a class="gal-left ajaxy" data-image-id="{$oNextImage->getId()}" href="{$oNextImage->getUrlFull()}?order={$sOrder}">
                    ←
