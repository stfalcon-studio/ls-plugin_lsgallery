...
<div class="gallery-albums-preview">
    <h2 class="title">{$aLang.plugin.lsgallery.lsgallery_image_user_marked}{$iPhotoCount} {$iPhotoCount|declension:$aLang.plugin.lsgallery.lsgallery_declension_images}</h2>
