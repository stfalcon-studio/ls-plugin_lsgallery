...
<form id="ls_gallery_create_album" action="" method="POST">
    <p>
        ...
        <input type="text" id="album_title" name="album_title" value="{$_aRequest.album_title}" /><br/>
    ...
    <p>
        ...
        <textarea rows="5" id="album_description" name="album_description">{$_aRequest.album_description}</textarea>
    </p>
    <p>
