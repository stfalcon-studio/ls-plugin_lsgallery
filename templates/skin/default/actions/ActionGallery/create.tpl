...
<form id="ls_gallery_create_album" action="" method="POST">
    <p>
        <label for="album_title">{$aLang.plugin.lsgallery.lsgallery_album_title}</label><br/>
    ...
    <p>
        <label for="album_type">{$aLang.plugin.lsgallery.lsgallery_album_type}</label><br/>
    ...
    <p>
        <label for="album_description">{$aLang.plugin.lsgallery.lsgallery_album_description}</label><br/>
    ...
    <p>
        ...
        <input type="submit" name="submit_create_album" value="{$aLang.plugin.lsgallery.lsgallery_save}" />
    </p>
</form>
